...
package com.deemsysinc.neetar11biophase1.downloader;
...
public class Helpers {
    ...
    public static String getPartialName(Context c, boolean mainFile, int versionCode) {
        return (mainFile ? "main." : "patch.") + versionCode + "." + c.getPackageName() +".obb" +".tmp";
    }
