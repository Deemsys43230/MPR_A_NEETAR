 ...
 */
package com.deemsysinc.neetar11biophase3.drawers;
...
//     */
    public void createOnGlThread(Context context, Obj obj,ZipResourceFile expansionFile,
                                 String textureName,String materialname) throws IOException {

        // Read the texture.
        Log.d("TextureAssName",""+textureName);
        InputStream inputStream=expansionFile.getInputStream(textureName);
...
//            textureBitmap = BitmapFactory.decodeStream(textureStream,null,bfo);
//        }catch (Exception e)
//        {
//            Log.d("PrintStraceBit",e.toString());
//        }
...
//        Log.d("PrintAmbient",""+mAmbient);
        ...
        Log.d("PrintTransPMode",""+transparencyMode);
//        else
//        {
//            GLES20.glDepthMask(false);
//            GLES20.glDisable(GLES20.GL_BLEND);
