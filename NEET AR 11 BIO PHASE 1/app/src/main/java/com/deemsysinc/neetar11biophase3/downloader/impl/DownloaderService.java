...
package com.deemsysinc.neetar11biophase3.downloader.impl;
...
import com.deemsysinc.android.vending.licensing.AESObfuscator;
import com.deemsysinc.android.vending.licensing.APKExpansionPolicy;
import com.deemsysinc.android.vending.licensing.LicenseChecker;
import com.deemsysinc.android.vending.licensing.LicenseCheckerCallback;
import com.deemsysinc.android.vending.licensing.Policy;
import com.deemsysinc.neetar11biophase3.activities.MenuActivity;
import com.deemsysinc.neetar11biophase3.downloader.Constants;
import com.deemsysinc.neetar11biophase3.downloader.DownloadProgressInfo;
import com.deemsysinc.neetar11biophase3.downloader.DownloaderServiceMarshaller;
import com.deemsysinc.neetar11biophase3.downloader.Helpers;
import com.deemsysinc.neetar11biophase3.downloader.IDownloaderClient;
import com.deemsysinc.neetar11biophase3.downloader.IDownloaderService;
import com.deemsysinc.neetar11biophase3.downloader.IStub;
...
public abstract class DownloaderService extends CustomIntentService implements IDownloaderService {
    ...
    public static int startDownloadServiceIfRequired(Context context,
        ...
        return startDownloadServiceIfRequired(context, pendingIntent,
                packageName, className, serviceClass);
    }
     ...
     */
    public static int startDownloadServiceIfRequired(Context context,
                                                     PendingIntent pendingIntent, String classPackage, String className, Class<?> serviceClass)
            throws NameNotFoundException {
    ...
    public void notifyUpdateBytes(long totalBytesSoFar) {
        ...
        Log.d("DownloadService", "Total" + mTotalLength + "   Total Far" + totalBytesSoFar + "   Total Remaining" + timeRemaining + " Avg.Speed" + mAverageDownloadSpeed);
        ...
        MenuActivity.setDownloadProgress(new DownloadProgressInfo(mTotalLength,
                totalBytesSoFar,
                timeRemaining,
                mAverageDownloadSpeed));
    }
