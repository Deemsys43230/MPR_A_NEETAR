...
public class BillingManager implements PurchasesUpdatedListener {
    ...
    private final List<Purchase> mPurchaseshistory = new ArrayList<>();
    ...
    public interface BillingUpdatesListener {
        ...
        void onPurchaseHistoryResponse(List<Purchase> purchases);

        void onPurchaseReponse(String response);
...
//                queryPurchases();
    ...
    public void onPurchasesUpdated(int resultCode, List<Purchase> purchases) {
        switch (resultCode) {
            case BillingResponse.OK:
                ...
                mBillingUpdatesListener.onPurchaseReponse("");
                break;
            case BillingResponse.USER_CANCELED:
                String responseString1 = "User cancelled payment";
                mBillingUpdatesListener.onPurchaseReponse(responseString1);
                Log.i(TAG, responseString1);
                break;
            case BillingResponse.SERVICE_UNAVAILABLE:
                String responseString2 = "Slow Network connection. Please try again later.";
                mBillingUpdatesListener.onPurchaseReponse(responseString2);
                Log.i(TAG, responseString2);
                break;
            case BillingResponse.BILLING_UNAVAILABLE:
                String responseString3 = "Payment failed due to technical error. Please try again later.";
                mBillingUpdatesListener.onPurchaseReponse(responseString3);
                Log.i(TAG, responseString3);
                break;
            case BillingResponse.ITEM_UNAVAILABLE:
                String responseString4 = "Payment failed due to technical error. Please try again later.";
                mBillingUpdatesListener.onPurchaseReponse(responseString4);
                Log.i(TAG, responseString4);
                break;
            case BillingResponse.DEVELOPER_ERROR:
                String responseString5 = "Payment failed due to technical error. Please try again later.";
                mBillingUpdatesListener.onPurchaseReponse(responseString5);
                Log.i(TAG, responseString5);
                break;
            case BillingResponse.ERROR:
                String responseString6 = "Payment failed due to technical error. Please try again later.";
                mBillingUpdatesListener.onPurchaseReponse(responseString6);
                Log.i(TAG, responseString6);
                break;
            case BillingResponse.ITEM_ALREADY_OWNED:
                String responseString7 = "You have already purchased this item. Click RESTORE to update your purchase list.";
                mBillingUpdatesListener.onPurchaseReponse(responseString7);
                Log.i(TAG, responseString7);
                break;
            case BillingResponse.ITEM_NOT_OWNED:
                String responseString8 = "Payment failed due to technical error. Please try again later.";
                mBillingUpdatesListener.onPurchaseReponse(responseString8);
                Log.i(TAG, responseString8);
                break;
        }
    }
    ...
    public void querySkuDetailsAsync1(@SkuType final String itemType, final List<String> skuList,
...
//                                mBillingUpdatesListener.onSkuDetailsResponse(responseCode, skuDetailsList);
                            }
                        });
            }
        };
        ...
        mBillingClient.queryPurchaseHistoryAsync(SkuType.INAPP, new PurchaseHistoryResponseListener() {
            ...
            public void onPurchaseHistoryResponse(int responseCode, List<Purchase> purchasesList) {
                if (responseCode == BillingResponse.OK) {
                    ...
                    mBillingUpdatesListener.onPurchaseHistoryResponse(mPurchaseshistory);
